...
import static com.ningso.silence.downloader.bizs.DLCons.DBCons.TB_TASK;
import static com.ningso.silence.downloader.bizs.DLCons.DBCons.TB_TASK_CURRENT_BYTES;
import static com.ningso.silence.downloader.bizs.DLCons.DBCons.TB_TASK_DIR_PATH;
import static com.ningso.silence.downloader.bizs.DLCons.DBCons.TB_TASK_DISPOSITION;
import static com.ningso.silence.downloader.bizs.DLCons.DBCons.TB_TASK_ETAG;
import static com.ningso.silence.downloader.bizs.DLCons.DBCons.TB_TASK_FILE_NAME;
import static com.ningso.silence.downloader.bizs.DLCons.DBCons.TB_TASK_LOCATION;
import static com.ningso.silence.downloader.bizs.DLCons.DBCons.TB_TASK_MIME_TYPE;
import static com.ningso.silence.downloader.bizs.DLCons.DBCons.TB_TASK_TOTAL_BYTES;
import static com.ningso.silence.downloader.bizs.DLCons.DBCons.TB_TASK_URL_BASE;
import static com.ningso.silence.downloader.bizs.DLCons.DBCons.TB_TASK_URL_REAL;
