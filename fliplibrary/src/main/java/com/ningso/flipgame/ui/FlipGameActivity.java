package com.ningso.flipgame.ui;
...
import com.ningso.flipgame.R;
import com.ningso.flipgame.anim.ExplosionField;
import com.ningso.flipgame.anim.Rotate3dAnimation;
import com.ningso.flipgame.utils.CardIndexManager;
import com.ningso.flipgame.widgets.LinkCountDownView;
import com.ningso.flipgame.widgets.SpacingDecoration;

/**
 * Created by NingSo on 2016/11/7.下午3:35
 *
 * @author: NingSo
...
public class FlipGameActivity extends Activity {
    ...
    int starCount;
    public static int[] ImageSources = {R.drawable.emoji1, R.drawable.emoji2, R.drawable.emoji3, R.drawable.emoji4, R.drawable.emoji5, R.drawable.emoji6,
            R.drawable.emoji7, R.drawable.emoji8, R.drawable.emoji9, R.drawable.emoji10, R.drawable.emoji11, R.drawable.emoji12,
            R.drawable.emoji13, R.drawable.emoji14, R.drawable.emoji15, R.drawable.emoji16, R.drawable.emoji17};
    ...
    private void startGame() {
        ...
        mLinkCountDownView.start(3, 0, 2500, new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                isPreView = true;
                mExplosionField = ExplosionField.attach2Window(FlipGameActivity.this);
    ...
    class CardRecyclerViewAdapter extends RecyclerView.Adapter<CardRecyclerViewAdapter.CardViewHolder> {
        ...
        public void onBindViewHolder(final CardViewHolder holder, final int position) {
            if (isPreView) {
                ...
                holder.ivCard.setImageResource(R.drawable.defultcard);
            }
